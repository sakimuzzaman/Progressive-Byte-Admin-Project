...
//                 </div>
//                 <div className='pl-4'>
//                     <span className='  text-base text-gray-700 font-semibold'>Total Bills</span>
//                     <div className='flex items-center'>
//                         <strong className='text-3xl text-gray-700 font-semibold'>$1087446</strong>
...
//                 </div>
//                 <div className='pl-4'>
//                     <span className='text-base text-gray-700 font-semibold'>Total Invoice</span>
//                     <div className='flex items-center'>
//                         <strong className='text-3xl text-gray-700 font-semibold'>7000</strong>
...
//                 </div>
//                 <div className='pl-4'>
//                     <span className='text-base text-gray-700 font-semibold'>Total Customers</span>
//                     <div className='flex items-center'>
//                         <strong className='text-3xl text-gray-700 font-semibold'>$5490</strong>
...
//                 </div>
//                 <div className='pl-4'>
//                     <span className='text-base text-gray-700 font-semibold'>Total Vendors</span>
//                     <div className='flex items-center'>
//                         <strong className='text-3xl text-gray-700 font-semibold'>578</strong>
...
// }
            ...
            // <div className='bg-white rounded-lg p-4 flex-1 border border-gray-200 flex items-center'>a</div>
            // <div className='bg-white rounded-lg p-4 flex-1 border border-gray-200 flex items-center'>b</div>
            // <div className='bg-white rounded-lg p-4 flex-1 border border-gray-200 flex items-center'>c</div>
            // <div className='bg-white rounded-lg p-4 flex-1 border border-gray-200 flex items-center'>d</div>
